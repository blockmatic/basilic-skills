...
Use `/workflow` for the catalog, `/workflow plan`, `/workflow build`, `/workflow review`, or a full `/<playbook>` name. FIRST `/f-*` remains separate. See [adoption](docs/workflow-adoption.md) for structure and checklists.
