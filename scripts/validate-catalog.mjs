...
for (const file of skillFiles) {
  ...
  if (!name) {
    ...
    errors.push(`${rel}: playbook name cannot be "workflow" (reserved for the dispatcher)`)
...
try {
  ...
  if (leftoverB.isDirectory())
    errors.push('skills/b: leftover second workflow tree; keep only skills/workflow')
} catch (error) {
