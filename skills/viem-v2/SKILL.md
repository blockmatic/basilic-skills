...
**Wallet UI:** React wallet connect and hooks belong in [wagmi-v3](../wagmi-v3/SKILL.md). Do not add wagmi to an app that has no wallet UI yet. Use viem directly for backends, scripts, and address/signature verification.
...
- React wallet UI → [wagmi-v3](../wagmi-v3/SKILL.md) (built on viem)
- Ethereum hashing (selectors, topics, EIP-712) → [nodejs-keccak256-v1](../nodejs-keccak256-v1/SKILL.md)
- Non-EVM chains → [solana-v1](../solana-v1/SKILL.md)
