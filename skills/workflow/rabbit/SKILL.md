...
Fetch CodeRabbit comments for the current PR or uncommitted diff. Apply high-confidence fixes. Follow [git publish](../references/git-publish.md).
...
- [ ] No commit was created unless the user asked for `/commit`.

## Handoff

Summarize applied fixes, skipped items, and remaining comments. Point at `/commit` if the user wants to publish.
