...
1. Inspect the working tree and identify the files owned by this task. State the acceptance conditions; preserve unrelated changes. If there is no plan and the area spans packages or is unfamiliar, follow [council](../w-council/SKILL.md) steps 1–3 first.
...
5. If behavior, commands, or conventions changed, update matching MDX and nearest README; otherwise one line why not.
