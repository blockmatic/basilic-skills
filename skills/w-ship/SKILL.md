...
2. Implement in complete slices. Docs as `/w-build`: matching MDX and nearest README when behavior/commands/conventions changed (`PRODUCT.md` only if product facts changed), or one line why not.
